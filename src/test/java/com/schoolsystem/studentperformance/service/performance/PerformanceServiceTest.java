...
public class PerformanceServiceTest {
    ...
    void testGetStudentAverageGradeBySubject() {
        Performance p1 = new Performance(null, null, 5, 40, "Отлично");
        Performance p2 = new Performance(null, null, 4, 20, "Хорошо");
        Performance p3 = new Performance(null, null, 3, 10, "Средне");
